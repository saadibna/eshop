			...
			<div class="row">
				<div class="col-12">
					...
					<table class="table shopping-summery">
						...
						<tbody>
							<tr>
								<td class="image" data-title="No"><img src="https://source.unsplash.com/100x100/?style,cloth" alt="#"></td>
									...
									<div class="product-gallery">
										<div class="quickview-slider-active">
											<div class="single-slider">
												<img src="{{asset('assets/frontend')}}/images/modal1.jpg" alt="#">
											</div>
											<div class="single-slider">
												<img src="{{asset('assets/frontend')}}/images/modal2.jpg" alt="#">
											</div>
											<div class="single-slider">
												<img src="{{asset('assets/frontend')}}/images/modal3.jpg" alt="#">
											</div>
											<div class="single-slider">
												<img src="{{asset('assets/frontend')}}/images/modal4.jpg" alt="#">
											</div>
										</div>
									</div>
								<!-- End Product slider -->
