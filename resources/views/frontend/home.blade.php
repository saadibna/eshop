								...
								<div class="shopping-item">
									...
									<ul class="shopping-list">
										<li>
											...
											<a class="cart-img" href="#"><img src="https://source.unsplash.com/70x70/?nature,cloth" alt="#"></a>
											<h4><a href="#">Woman Ring</a></h4>
											<p class="quantity">1x - <span class="amount">$99.00</span></p>
										</li>
										<li>
											<a href="#" class="remove" title="Remove this item"><i class="fa fa-remove"></i></a>
											<a class="cart-img" href="#"><img ="https://source.unsplash.com/70x70/?nature,cloth" alt="#"></a>
									...
									<li class="main-mega"><a href="#">best selling <i class="fa fa-angle-right" aria-hidden="true"></i></a>
										<ul class="mega-menu">
											<li class="single-menu">
												...
												<div class="image">
													<img src="https://source.unsplash.com/225x155/?fashion,cloth" alt="#">
												</div>
										...
										<div class="nav-inner">	
											<ul class="nav main-menu menu navbar-nav">
													...
													<li><a href="#">Blog<i class="ti-angle-down"></i></a>
														<ul class="dropdown">
															<li><a href="{{route('blog-single-page')}}">Blog Single Sidebar</a></li>
														</ul>
													</li>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="single-banner">
						<img src="https://source.unsplash.com/600x370/?fashion,cloth" alt="#">
						<div class="content">
												...
												<div class="single-product">
													<div class="product-img">
														<a href="product-details.html">
															<img class="default-img" src="https://source.unsplash.com/550x750/?fashion,cloth" alt="#">
															<img class="hover-img" src="https://source.unsplash.com/550x750/?fashion,cloth" alt="#">
														</a>
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-12">
								<div class="list-image overlay">
									<img src="https://source.unsplash.com/115x140/?fashion,dress" alt="#">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-6 col-12 padding-right">
						<div class="image">
							<img src="https://source.unsplash.com/750x590/?fashion,dress" alt="#">
						</div>	
					</div>	
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-12">
					...
					<div class="shop-single-blog">
						<img src="https://source.unsplash.com/370x300/?fashion,dress" alt="#">
						<div class="content">
                                ...
                                <!-- Product Slider -->
									<div class="product-gallery">
										<div class="quickview-slider-active">
											<div class="single-slider">
												<img src="https://source.unsplash.com/569x528/?fashion,dress" alt="#">
											</div>
											<div class="single-slider">
												<img src="https://source.unsplash.com/569x528/?fashion,dress" alt="#">
											</div>
